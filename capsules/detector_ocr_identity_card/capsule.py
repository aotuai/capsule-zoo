...
class Capsule(BaseCapsule):
    name = "detector_ocr_identity_card"
    description = "✨ v0.1.0 identity card OCR text detector and recognition: support over 6000 Chinese charactors."
    version = 1
    ...
    backend_loader = lambda capsule_files, device: Backend(
        ...
        rec_bytes=capsule_files["models/identity_card_rec_20240823.onnx"],
