...
class Capsule(BaseCapsule):
    name = "detector_ocr_business_license"
    description = "✨ v0.1.0 business license OCR text detector and recognition: support over 6000 Chinese charactors."
    version = 1
    ...
    backend_loader = lambda capsule_files, device: Backend(
        device=device,
        det_bytes=capsule_files["models/business_license_det_20240918.onnx"],
        rec_bytes=capsule_files["models/business_license_rec_20240918.onnx"],
    ...
    options = {
        **common_detector_options,
        ...
        "to_gray": BoolOption(default=True),
    }
